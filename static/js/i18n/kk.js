...
window.APP_I18N_LOCALES['kk'] = {
    "languageName": "Қазақша",
    "ui": {
        "title": "Код талдағышы және оқу Gist генераторы",
        ...
        "runButton": "Code Review Gist жасау",
        "readyLog": "Жүйе дайын. Мәліметтерді толтырып, батырманы басыңыз."
    },
    "alerts": {
