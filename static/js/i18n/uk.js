...
window.APP_I18N_LOCALES['uk'] = {
    "languageName": "Українська",
    "ui": {
        "title": "Аналізатор коду та генератор навчального Gist",
        ...
        "runButton": "Згенерувати Code Review Gist",
        "readyLog": "Система готова. Заповніть дані та натисніть кнопку."
    },
    "alerts": {
